$(function () {
    ...
    var generate = function () {
        ...
        ctx.font = "18px Arial";
        ctx.fillStyle = "#fff";
        ctx.fillText("   Ráscale aquí", 20, 100);

        var coupons = ['<b>Perdón!</b><br>No hay nada aquí!! :(', '<b>Felicidades!</b><br>5 minutos libres<b> en Suburbia!</b>', '<b>Noooo :(</b><br>Intenta otra vez!!', '<b>Muy bien!!</b><br>Ganaste (<span style="color:#DA4453">&hearts; &hearts; &hearts;</span>) tres corazones!'];
